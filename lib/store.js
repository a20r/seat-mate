...
// Where guest/state/config JSON lives. On Railway, point this at a mounted
// volume (RAILWAY_VOLUME_MOUNT_PATH is set automatically when one is attached)
// so the data survives redeploys. Falls back to the local ./data folder.
